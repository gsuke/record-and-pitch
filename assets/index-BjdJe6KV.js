...
` +
    ...
    var dt = Math.random().toString(36).slice(2),
      ...
      vt = `__reactMarker$` + dt;
    function yt(e) {
      (delete e[ft], delete e[pt], delete e[N], delete e[ht], delete e[gt]);
    }
    function bt(e) {
      var t = e[ft];
      if (t) return t;
    ...
    function Dt(e, t) {
      for (P[e] = t, e = 0; e < t.length; e++) Tt.add(t[e]);
    }
    var Ot = RegExp(
    ...
    function hi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) fi(e) && (s = 1);
        ...
        a: switch (e) {
          ...
          case w:
            return ((e = di(13, n, t, a)), (e.elementType = w), (e.lanes = o), e);
          case te:
    ...
    function xi(e, t) {
      if (typeof e == `object` && e) {
        var n = bi.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: Te(t) }), bi.set(e, t), t) : n;
      }
    ...
    function za(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === T && Aa(i) === t.type))
    ...
    function nc(e, t, n, r, a) {
      ...
      if (((o = xi(o, n)), Xl === null ? (Xl = [o]) : Xl.push(o), X !== 4 && (X = 2), t === null))
        return !0;
      ((r = xi(r, n)), (n = t));
      do {
        switch (n.tag) {
    ...
    function mc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((co(t), a)) {
          ...
          if (((r = K), r !== null && ((s = ot(r, n)), s !== 0 && s !== o.retryLane)))
    ...
    function Cc(e, t, n) {
      var r = t.pendingProps,
        ...
        s;
      if (
        ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : !!(R.current & 2)),
        s && ((a = !0), (t.flags &= -129)),
        (s = !!(t.flags & 32)),
        (t.flags &= -33),
        e === null)
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = K), s !== null && ((r = ot(s, n)), r !== 0 && r !== l.retryLane)))
    ...
    function zc(e, t, n) {
      ...
      switch ((Pi(t), t.tag)) {
        ...
        case 27:
          if ((ve(t), (n = me.current), (a = t.type), e !== null && t.stateNode != null))
        ...
        if (!(t & 7)) {
          a: {
            if (
              ...
              c && n !== rn && (u = n.relatedTarget || n.fromElement) && (bt(u) || u[mt]))
            )
              break a;
            if (
              (l || c) &&
...
`,
    ...
    function Vf(e, t, n) {
      ...
      for (r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++) {
        var a = n[i];
        if (
          !(a[vt] || a[ft] || (e === `link` && a.getAttribute(`rel`) === `stylesheet`)) &&
  ...
  y = class {
    ...
    clear() {
      (this._vector.fill(0), (this._position = 0), (this._frameCount = 0));
    }
    put(e) {
      this._frameCount += e;
    }
    putSamples(e, t, n = 0) {
      ...
      let a = this.endIndex;
      (this.vector.set(e.subarray(r, r + i), a), (this._frameCount += n));
    }
    putBuffer(e, t, n = 0) {
      ((t ||= 0), n >= 0 || (n = e.frameCount - t), this.putSamples(e.vector, e.position + t, n));
    }
    receive(e) {
    ...
    receiveSamples(e, t = 0) {
      let n = t * 2,
        r = this.startIndex;
      (e.set(this._vector.subarray(r, r + n)), this.receive(t));
    }
    extract(e, t = 0, n = 0) {
      let r = this.startIndex + t * 2,
        i = n * 2;
    ...
    ensureCapacity(e = 0) {
      ...
      if (this._vector.length < t) {
        ...
        (e.set(this._vector.subarray(this.startIndex, this.endIndex)),
          (this._vector = e),
          (this._position = 0));
      } else this.rewind();
    }
  ...
  b = class {
    constructor(e) {
      e
        ? ((this._inputBuffer = new y()), (this._outputBuffer = new y()))
  ...
  x = class e extends b {
    ...
    process() {
      let e = this._inputBuffer.frameCount;
      this._outputBuffer.ensureAdditionalCapacity(e / this._rate + 1);
      let t = this.transpose(e);
      (this._inputBuffer.receive(), this._outputBuffer.put(t));
    }
    transpose(e = 0) {
      if (e === 0) return 0;
      let t = this._inputBuffer.vector,
        n = this._inputBuffer.startIndex,
        r = this._outputBuffer.vector,
        i = this._outputBuffer.endIndex,
        a = 0,
        o = 0;
      for (; this.slopeCount < 1;)
        ((r[i + 2 * o] = (1 - this.slopeCount) * this.prevSampleL + this.slopeCount * t[n]),
          (r[i + 2 * o + 1] =
            (1 - this.slopeCount) * this.prevSampleR + this.slopeCount * t[n + 1]),
          (o += 1),
          (this.slopeCount += this._rate));
      if ((--this.slopeCount, e !== 1))
        out: for (;;) {
          for (; this.slopeCount > 1;) if ((--this.slopeCount, (a += 1), a >= e - 1)) break out;
          let s = n + 2 * a;
      ...
      return ((this.prevSampleL = t[n + 2 * e - 2]), (this.prevSampleR = t[n + 2 * e - 1]), o);
    }
  },
  ee = class {
    constructor(e) {
    ...
    fillOutputBuffer(e = 0) {
      for (; this.outputBuffer.frameCount < e;) {
        let e = 16384 - this.inputBuffer.frameCount;
  ...
  C = class extends ee {
    ...
    set position(e) {
      ...
      let t = this.outputBufferPosition - (this._position - e);
      if (t < 0) throw RangeError(`New position falls outside of history buffer`);
    ...
    fillInputBuffer(e = 0) {
      let t = new Float32Array(e * 2),
        n = this.sourceSound.extract(t, e, this._sourcePosition);
      ((this._sourcePosition += n), this.inputBuffer.putSamples(t, 0, n));
    }
    extract(e, t = 0) {
      this.fillOutputBuffer(this.outputBufferPosition + t);
      let n = Math.min(t, this.outputBuffer.frameCount - this.outputBufferPosition);
      this.outputBuffer.extract(e, this.outputBufferPosition, n);
      let r = this.outputBufferPosition + n;
      return (
        (this.outputBufferPosition = Math.min(this.historyBufferSize, r)),
  ...
  ue = class e extends b {
    constructor(e) {
      (super(e),
        ...
        (this._tempo = 1),
        this.setParameters(44100, w, te, ne));
    }
    clear() {
    ...
    clearMidBuffer() {
      ((this.midBufferDirty = !1),
        (this.midBuffer = null),
        this.refMidBuffer && this.refMidBuffer.fill(0),
        (this.skipFract = 0));
    }
    setParameters(e, t, n, r) {
      (e > 0 && (this.sampleRate = e),
        r > 0 && (this.overlapMs = r),
        t > 0 ? ((this.sequenceMs = t), (this.autoSeqSetting = !1)) : (this.autoSeqSetting = !0),
        n > 0
          ? ((this.seekWindowMs = n), (this.autoSeekSetting = !1))
          : (this.autoSeekSetting = !0),
    ...
    set tempo(e) {
      ...
      ((this._tempo = e),
        ...
        (this.skipFract = 0),
        (t = Math.floor(this.nominalSkip + 0.5)),
        (this.sampleReq =
          Math.max(t + this.overlapLength, this.seekWindowLength) + this.seekLength));
    }
    get tempo() {
      return this._tempo;
    }
    ...
    calculateSequenceParameters() {
      ...
      (this.autoSeqSetting &&
        ((e = se + oe * this._tempo),
        (e = this.checkLimits(e, ae, ie)),
        (this.sequenceMs = Math.floor(e + 0.5))),
        this.autoSeekSetting &&
          ((t = D + E * this._tempo),
          (t = this.checkLimits(t, le, ce)),
    ...
    seekBestOverlapPositionStereo() {
      let e,
        ...
        r = 0;
      for (
        this.preCalculateCorrelationReferenceStereo(), e = 0, t = Number.MIN_VALUE;
        r < this.seekLength;
        r += 1
      )
        ((n = this.calculateCrossCorrelationStereo(2 * r, this.refMidBuffer)),
          n > t && ((t = n), (e = r)));
      return e;
    }
    seekBestOverlapPositionStereoQuick() {
      let e,
        ...
        a;
      for (
        this.preCalculateCorrelationReferenceStereo(), t = Number.MIN_VALUE, e = 0, i = 0, a = 0;
        r < 4;
        r += 1
      ) {
        let o = 0;
        for (; T[r][o] && ((a = i + T[r][o]), !(a >= this.seekLength));)
          ((n = this.calculateCrossCorrelationStereo(2 * a, this.refMidBuffer)),
            n > t && ((t = n), (e = a)),
            (o += 1));
        i = e;
      }
    ...
    preCalculateCorrelationReferenceStereo() {
      let e = 0,
        t,
        n;
      for (; e < this.overlapLength; e += 1)
        ((n = e * (this.overlapLength - e)),
          (t = e * 2),
          (this.refMidBuffer[t] = this.midBuffer[t] * n),
          (this.refMidBuffer[t + 1] = this.midBuffer[t + 1] * n));
    }
    calculateCrossCorrelationStereo(e, t) {
      ...
      let r = 0,
        i = 2,
        a = 2 * this.overlapLength,
        o;
      for (; i < a; i += 2) ((o = i + e), (r += n[o] * t[i] + n[o + 1] * t[i + 1]));
      return r;
    }
    overlap(e) {
    ...
    overlapStereo(e) {
      let t = this._inputBuffer.vector;
      e += this._inputBuffer.startIndex;
      let n = this._outputBuffer.vector,
        r = this._outputBuffer.endIndex,
        i = 0,
        a,
        o,
        s = 1 / this.overlapLength,
        c,
        l,
        u;
      for (; i < this.overlapLength; i += 1)
        ((o = (this.overlapLength - i) * s),
          (c = i * s),
          (a = 2 * i),
          (l = a + e),
          (u = a + r),
          (n[u + 0] = t[l + 0] * c + this.midBuffer[a + 0] * o),
          (n[u + 1] = t[l + 1] * c + this.midBuffer[a + 1] * o));
    }
    process() {
      let e, t, n;
      ...
      for (; this._inputBuffer.frameCount >= this.sampleReq;) {
        ((e = this.seekBestOverlapPosition()),
          ...
          (t = this.seekWindowLength - 2 * this.overlapLength),
          t > 0 && this._outputBuffer.putBuffer(this._inputBuffer, e + this.overlapLength, t));
        let r = this._inputBuffer.startIndex + 2 * (e + this.seekWindowLength - this.overlapLength);
  ...
  fe = class e {
    constructor() {
      ((this.transposer = new x(!1)),
        (this.stretch = new ue(!1)),
        (this._inputBuffer = new y()),
        (this._intermediateBuffer = new y()),
        (this._outputBuffer = new y()),
        (this._rate = 0),
        (this._tempo = 0),
        (this.virtualPitch = 1),
        (this.virtualRate = 1),
    ...
    calculateEffectiveRateAndTempo() {
      ...
      ((this._tempo = this.virtualTempo / this.virtualPitch),
        ...
        de(this._tempo, e) && (this.stretch.tempo = this._tempo),
        de(this._rate, t) && (this.transposer.rate = this._rate),
        this._rate > 1
  ...
  O = class {
    ...
    extract(e, t = 0, n = 0) {
      this.position = n;
      let r = this.buffer.getChannelData(0),
        i = this.dualChannel ? this.buffer.getChannelData(1) : this.buffer.getChannelData(0),
        a = 0;
      for (; a < t; a++) ((e[a * 2] = r[a + n]), (e[a * 2 + 1] = i[a + n]));
      return Math.min(t, r.length - n);
    }
  },
  k = function (e, t, n = S, r = 4096) {
    let i = e.createScriptProcessor(r, 2, 2),
      a = new Float32Array(r * 2);
    return (
      (i.onaudioprocess = (e) => {
        let i = e.outputBuffer.getChannelData(0),
          o = e.outputBuffer.getChannelData(1),
          s = t.extract(a, r);
        (n(t.sourcePosition), s === 0 && t.onEnd());
        let c = 0;
        for (; c < s; c++) ((i[c] = a[c * 2]), (o[c] = a[c * 2 + 1]));
      }),
      i
    );
  },
  ...
  pe = function (e) {
    let t = Math.floor(e / 60),
      n = e - t * 60;
    return `${t}:${A(parseInt(n), 2)}`;
  },
  j = function (e) {
    let t = this.timePlayed,
      n = this.sampleRate;
    if (((this.sourcePosition = e), (this.timePlayed = e / n), t !== this.timePlayed)) {
      let e = new CustomEvent(`play`, {
        detail: {
  ...
  me = class {
    constructor(e, t, n, r = S) {
      this._soundtouch = new fe();
      let i = new O(t);
      ((this.timePlayed = 0),
        (this.sourcePosition = 0),
        (this._filter = new C(i, this._soundtouch, r)),
        (this._node = k(e, this._filter, (e) => j.call(this, e), n)),
        (this.tempo = 1),
        (this.rate = 1),
    ...
    get formattedDuration() {
      return pe(this.duration);
    }
    get formattedTimePlayed() {
      return pe(this.timePlayed);
    }
    ...
    on(e, t) {
      (this.listeners.push({ name: e, cb: t }), this._node.addEventListener(e, (e) => t(e.detail)));
    }
    off(e = null) {
      let t = this.listeners;
      (e && (t = t.filter((t) => t.name === e)),
        t.forEach((e) => {
          this._node.removeEventListener(e.name, (t) => e.cb(t.detail));
        }));
    }
  },
  he = 300;
function ge() {
  ...
  function h() {
    (e && e.state !== `inactive` && e.stop(), (c &&= (clearInterval(c), null)));
  }
  function g(e) {
    if (!t || !i) return;
  ...
  function v() {
    ((n &&= (n.off(`play`), n.off(`end`), n.off(`timeupdate`), n.disconnect(), null)),
      (r &&= (r.disconnect(), null)));
  }
  function y(e, n) {
    let r = Math.floor(Math.min(n, e.duration - 0.01) * e.sampleRate),
      i = e.length - r,
      a = e.numberOfChannels,
      o = t.createBuffer(a, i, e.sampleRate);
    for (let t = 0; t < a; t++) {
      let n = e.getChannelData(t);
      o.getChannelData(t).set(n.subarray(r));
    }
    return o;
  }
  return {
    ...
    toggleRecording() {
      ...
      ((l = 0),
        ...
        navigator.mediaDevices
          ...
          .then((r) => {
            ((e = new MediaRecorder(r, { mimeType: `audio/webm;codecs=opus` })),
              (e.ondataavailable = (e) => {
                e.data.size > 0 && n.push(e.data);
              }),
              (e.onstop = async () => {
                let e = new Blob(n, { type: `audio/webm;codecs=opus` });
                t = new AudioContext();
                let a = await e.arrayBuffer();
                ((i = await t.decodeAudioData(a)),
          ...
          .catch((e) => {
            (alert(`マイクへのアクセスできませんでした。`), console.error(e));
          }));
    },
    togglePlayPause() {
      s === `playing` ? _() : g(s === `paused` ? Math.min(a, (i?.duration ?? 0) - 0.01) : 0);
    },
    stop() {
      (v(), (a = 0), (s = `idle`), p());
    },
    seek(e) {
      (s === `playing` && v(), setTimeout(() => g(e), 50));
    },
    setPitch(e) {
      ((o = e), n && (n.pitch = 2 ** (e / 12)), p());
    },
    setVolume(e) {
      ((u = e), r && (r.gain.value = e), p());
    },
  };
}
var _e = o((e) => {
...
function ve({ isRecording: e, isDisabled: t, onToggle: n }) {
...
function ye({ isPlaying: e, isDisabled: t, onClick: n }) {
  return (0, M.jsx)(`button`, {
    onClick: n,
    disabled: t,
...
function be(e, t) {
  let n = e.getChannelData(0),
    r = Math.floor(n.length / t),
    i = [];
  for (let e = 0; e < t; e++) {
    let t = r * e,
      a = 0;
    for (let e = 0; e < r; e++) {
      let r = Math.abs(n[t + e] ?? 0);
      r > a && (a = r);
    }
    i.push(a);
  }
...
function xe(e, t, n) {
  ...
  for (let e = 0; e < t.length; e++) {
    let n = e * o,
      i = Math.max(2, t[e] * a * 0.9),
      c = (a - i) / 2;
    ((r.fillStyle = n < s ? `rgba(99,102,241,0.5)` : `rgba(99,102,241,0.25)`),
      r.fillRect(n, c, Math.max(1, o - 1), i));
  }
}
function Se(e) {
...
function Ce({ audio: e, leftControl: t }) {
  ...
  return (
    (0, _.useEffect)(() => {
      if (l) {
        let e = window.devicePixelRatio || 1,
          t = n.current;
        if (t) {
          let n = t.clientWidth * e,
            i = t.clientHeight * e;
          r.current && ((r.current.width = n), (r.current.height = i));
        }
        c.current = be(l, 120);
      } else c.current = [];
    }, [l]),
    (0, _.useEffect)(() => {
      function t() {
        let n = e.currentTime,
          l = e.duration,
          u = l > 0 ? Math.min(n / l, 1) : 0;
        (i.current && (i.current.style.width = `${u * 100}%`),
          a.current && (a.current.textContent = Se(n)),
          o.current && (o.current.textContent = Se(l)),
          r.current && c.current.length > 0 && xe(r.current, c.current, u),
      ...
      children: [
        ...
        (0, M.jsxs)(`div`, {
          ...
          children: [
            (0, M.jsxs)(`div`, {
              ...
              onClick: (t) => {
                let n = t.currentTarget.getBoundingClientRect(),
                  r = Math.max(0, Math.min(1, (t.clientX - n.left) / n.width));
                e.seek(r * e.duration);
              },
              children: [
                (0, M.jsx)(`canvas`, { ref: r, className: `absolute inset-0 w-full h-full` }),
                (0, M.jsx)(`div`, {
                  ref: i,
            ...
            (0, M.jsxs)(`div`, {
              className: `flex justify-between text-xs text-muted-foreground font-mono tabular-nums`,
              children: [
                (0, M.jsx)(`span`, { ref: a, children: `0:00` }),
                (0, M.jsx)(`span`, { ref: o, children: `0:00` }),
              ],
            }),
          ],
        }),
...
var Ee = (e, t) => {
  ...
  De = (e, t) => ({ classGroupId: e, validator: t }),
  Oe = (e = new Map(), t = null, n) => ({ nextPart: e, validators: t, classGroupId: n }),
  ke = `-`,
  Ae = [],
  je = `arbitrary..`,
  Me = (e) => {
  ...
  Ne = (e, t, n) => {
    ...
    let a = n.validators;
    if (a === null) return;
    let o = t === 0 ? e.join(ke) : e.slice(t).join(ke),
      s = a.length;
    for (let e = 0; e < s; e++) {
      let t = a[e];
  ...
  Ye = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(Ge)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(Ge) && ((c = s.slice(1)), (l = !0));
  ...
  dt = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/,
  ...
  gt = (e) => e.endsWith(`%`) && N(e.slice(0, -1)),
  _t = (e) => lt.test(e),
  vt = () => !0,
  yt = (e) => ut.test(e) && !dt.test(e),
  bt = () => !1,
  xt = (e) => ft.test(e),
  St = (e) => pt.test(e),
  Ct = (e) => !P(e) && !F(e),
  ...
  Ht = (e) => e === `position` || e === `percentage`,
  Ut = (e) => e === `image` || e === `url`,
  Wt = (e) => e === `length` || e === `size` || e === `bg-size`,
  Gt = (e) => e === `length`,
  Kt = (e) => e === `number`,
  qt = (e) => e === `family-name`,
  Jt = (e) => e === `number` || e === `weight`,
  Yt = (e) => e === `shadow`,
  Xt = rt(() => {
    let e = at(`color`),
      t = at(`font`),
      ...
      C = () => [F, P, c],
      w = () => [mt, `full`, `auto`, ...C()],
      te = () => [ht, `none`, `subgrid`, F, P],
      ne = () => [`auto`, { span: [`full`, ht, F, P] }, ht, F, P],
      T = () => [ht, `auto`, F, P],
      ...
      ce = () => [mt, `screen`, `full`, `dvw`, `lvw`, `svw`, `min`, `max`, `fit`, ...C()],
      le = () => [mt, `screen`, `full`, `lh`, `dvh`, `lvh`, `svh`, `min`, `max`, `fit`, ...C()],
      E = () => [e, F, P],
      D = () => [...b(), Ft, At, { position: [F, P] }],
      ue = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      de = () => [`auto`, `cover`, `contain`, It, Tt, { size: [F, P] }],
      fe = () => [gt, Nt, Et],
      O = () => [``, `none`, `full`, l, F, P],
      k = () => [``, N, Nt, Et],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, mt, P, F, g] }],
        container: [`container`],
        "container-type": [{ "@container": [``, `normal`, `size`, F, P] }],
        "container-named": [wt],
        ...
        flex: [{ flex: [N, mt, `auto`, `initial`, `none`, P] }],
        grow: [{ grow: [``, N, F, P] }],
        shrink: [{ shrink: [``, N, F, P] }],
        order: [{ order: [ht, `first`, `last`, `none`, F, P] }],
        ...
        "max-w": [{ "max-w": [s, `screen`, `none`, `prose`, { screen: [o] }, ...se()] }],
        h: [{ h: [`screen`, `lh`, ...se()] }],
        "min-h": [{ "min-h": [`screen`, `lh`, `none`, ...se()] }],
        "max-h": [{ "max-h": [`screen`, `lh`, ...se()] }],
        "font-size": [{ text: [`base`, n, Nt, Et] }],
        "font-smoothing": [`antialiased`, `subpixel-antialiased`],
        "font-style": [`italic`, `not-italic`],
        "font-weight": [{ font: [r, zt, Ot] }],
        "font-stretch": [
          {
            "font-stretch": [
              `ultra-condensed`,
        ...
        "line-clamp": [{ "line-clamp": [N, `none`, F, Dt] }],
        leading: [{ leading: [a, ...C()] }],
        ...
        "text-decoration-thickness": [{ decoration: [N, `from-font`, `auto`, F, Et] }],
        ...
        "bg-image": [
          {
            bg: [
              `none`,
              {
                linear: [{ to: [`t`, `tr`, `r`, `br`, `b`, `bl`, `l`, `tl`] }, ht, F, P],
                radial: [``, F, P],
                conic: [ht, F, P],
              },
              Lt,
        ...
        "outline-w": [{ outline: [``, N, Nt, Et] }],
        "outline-color": [{ outline: E() }],
        shadow: [{ shadow: [``, `none`, u, Rt, Mt] }],
        "shadow-color": [{ shadow: E() }],
        "inset-shadow": [{ "inset-shadow": [`none`, d, Rt, Mt] }],
        "inset-shadow-color": [{ "inset-shadow": E() }],
        "ring-w": [{ ring: k() }],
        "ring-w-inset": [`ring-inset`],
        "ring-color": [{ ring: E() }],
        "ring-offset-w": [{ "ring-offset": [N, Et] }],
        "ring-offset-color": [{ "ring-offset": E() }],
        "inset-ring-w": [{ "inset-ring": k() }],
        "inset-ring-color": [{ "inset-ring": E() }],
        "text-shadow": [{ "text-shadow": [`none`, f, Rt, Mt] }],
        ...
        "drop-shadow": [{ "drop-shadow": [``, `none`, p, Rt, Mt] }],
        ...
        transition: [
          { transition: [``, `all`, `colors`, `opacity`, `shadow`, `transform`, `none`, F, P] },
        ],
        ...
        "will-change": [{ "will-change": [`auto`, `scroll`, `contents`, `transform`, F, P] }],
        fill: [{ fill: [`none`, ...E()] }],
        "stroke-w": [{ stroke: [N, Nt, Et, Dt] }],
...
function en(e) {
  return Qt() ? e instanceof HTMLElement || e instanceof $t(e).HTMLElement : !1;
}
var tn = { ..._ },
  nn = {};
function rn(e, t) {
  let n = _.useRef(nn);
  return (n.current === nn && (n.current = e(t)), n);
}
var an = tn.useInsertionEffect,
  on = an && an !== tn.useLayoutEffect ? an : (e) => e();
function sn(e) {
  let t = rn(cn).current;
...
function ln() {}
var un = typeof document < `u` ? _.useLayoutEffect : () => {};
function dn(e, t) {
  if (e && !t) return e;
  if (!e && t) return t;
  if (e || t) return { ...e, ...t };
...
function pn(e, t, n, r, i) {
  if (!n && !r && !i && !e) return hn(t);
  let a = hn(e);
  return (t && (a = gn(a, t)), n && (a = gn(a, n)), r && (a = gn(a, r)), i && (a = gn(a, i)), a);
}
function mn(e) {
  if (e.length === 0) return fn;
  if (e.length === 1) return hn(e[0]);
  let t = hn(e[0]);
  for (let n = 1; n < e.length; n += 1) t = gn(t, e[n]);
  return t;
}
function hn(e) {
  return bn(e) ? { ...xn(e, fn) } : _n(e);
}
function gn(e, t) {
  return bn(t) ? xn(t, e) : vn(e, t);
}
function _n(e) {
  let t = { ...e };
  for (let e in t) {
  ...
  for (let n in t) {
    ...
    switch (n) {
      case `style`:
        ...
        break;
      case `className`:
        e[n] = Tn(e.className, r);
        break;
      default:
        e[n] = yn(n, r) ? Sn(e[n], r) : r;
    }
  }
  return e;
}
...
var On = Dn(`https://base-ui.com/production-error`, `Base UI`),
  kn = _.createContext(void 0);
function An(e = !1) {
  let t = _.useContext(kn);
  if (t === void 0 && !e) throw Error(On(16));
  return t;
}
function jn(e) {
  let {
...
function Mn(e, t, { detail: n = 0 } = {}) {
  e.dispatchEvent(
    new ($t(e).PointerEvent)(`click`, {
      bubbles: !0,
      cancelable: !0,
      composed: !0,
      detail: n,
...
function Nn(e = {}) {
  let {
    ...
    u = _.useCallback(() => {
      let e = o.current;
      Pn(e) && c && t && l.disabled === void 0 && e.disabled && (e.disabled = !1);
    }, [t, l.disabled, c]);
  return (
    un(u, [u]),
    {
          ...
          return pn(
            {
              ...
              onKeyDown(e) {
                if (t || (wn(e), o?.(e), e.baseUIHandlerPrevented)) return;
                ...
                if (n && c && d) {
                  ...
                  (e.preventDefault(), (!i || a) && (e.preventBaseUIHandler(), Mn(r, e)));
                  return;
                }
                if (!l || i || (!d && !u)) {
                ...
                e.defaultPrevented ||
                  (e.preventDefault(), u && (e.preventBaseUIHandler(), Mn(r, e)));
              },
              onKeyUp(e) {
                if (!t) {
                  if (
                    (wn(e),
                    a?.(e),
                    e.target === e.currentTarget && i && c && Pn(e.currentTarget) && e.key === ` `)
                  ) {
                    e.preventDefault();
                    return;
                  }
                  e.baseUIHandlerPrevented ||
                    (e.target === e.currentTarget &&
                      ...
                      !e.defaultPrevented &&
                      e.key === ` ` &&
                      (e.preventBaseUIHandler(), Mn(e.currentTarget, e)));
                }
              },
              onPointerDown(e) {
                if (t) {
...
function Pn(e) {
  return en(e) && e.tagName === `BUTTON`;
}
function Fn(e) {
  return en(e) && e.tagName === `A` && !!e.href;
}
function In(e, t, n, r) {
  let i = rn(Rn).current;
  return (zn(i, e, t, n, r) && Vn(i, [e, t, n, r]), i.callback);
}
function Ln(e) {
  let t = rn(Rn).current;
  return (Bn(t, e) && Vn(t, e), t.callback);
}
function Rn() {
...
function Yn(e, t, n = {}) {
  let r = t.render,
    i = Xn(t, n);
  return n.enabled === !1 ? null : $n(e, r, i, n.state ?? Gn);
}
function Xn(e, t = {}) {
  let { className: n, style: r, render: i } = e,
    { state: a = Gn, ref: o, props: s, stateAttributesMapping: c, enabled: l = !0 } = t,
    u = l ? qn(n, a) : void 0,
    d = l ? Jn(r, a) : void 0,
    f = l ? Kn(a, c) : Gn,
    p = l && s ? Zn(s) : void 0,
  ...
  return (
    typeof document < `u` &&
      (l
        ? (m.ref = Array.isArray(o) ? Ln([m.ref, Wn(i), ...o]) : In(m.ref, Wn(i), o))
        : In(null, null)),
    l
      ? (u !== void 0 && (m.className = Tn(m.className, u)),
        d !== void 0 && (m.style = dn(m.style, d)),
        m)
      : Gn
  );
}
function Zn(e) {
  return Array.isArray(e) ? mn(e) : pn(void 0, e);
}
...
function $n(e, t, n, r) {
  if (t) {
    ...
    e.ref = n.ref;
    let i = t;
    return (i?.$$typeof === Qn && (i = _.Children.toArray(t)[0]), _.cloneElement(i, e));
  }
  if (e && typeof e == `string`) return er(e, n);
  throw Error(On(8));
}
function er(e, t) {
  return e === `button`
...
var tr = _.forwardRef(function (e, t) {
    let {
        render: n,
        className: r,
        disabled: i = !1,
      ...
      { getButtonProps: l, buttonRef: u } = Nn({
        disabled: i,
        focusableWhenDisabled: a,
        native: o,
      });
    return Yn(`button`, e, { state: { disabled: i }, ref: [t, u], props: [c, l] });
  }),
  nr = (e) => (typeof e == `boolean` ? `${e}` : e === 0 ? `0` : e),
  rr = Te,
  ir = ((e, t) => (n) => {
...
function ar({ className: e, variant: t = `default`, size: n = `default`, ...r }) {
  return (0, M.jsx)(tr, {
    "data-slot": `button`,
    className: Zt(ir({ variant: t, size: n, className: e })),
    ...r,
  });
}
function or({ value: e, min: t, max: n, step: r, onValueChange: i, disabled: a, className: o }) {
  let s = ((e[0] - t) / (n - t)) * 100;
  function c() {
    i([Math.max(t, e[0] - r)]);
  }
  ...
  return (0, M.jsxs)(`div`, {
    className: Zt(`flex items-center gap-2`, o),
    children: [
      (0, M.jsx)(ar, {
        variant: `outline`,
        size: `icon-sm`,
      ...
      (0, M.jsxs)(`div`, {
        ...
        children: [
          ` `,
          (0, M.jsx)(`div`, {
            className: `absolute top-1/2 left-0 right-0 h-2 -translate-y-1/2 rounded-full bg-muted overflow-hidden`,
...
function sr({ value: e, disabled: t, onChange: n }) {
  return (0, M.jsxs)(`div`, {
    ...
    children: [
      (0, M.jsxs)(`div`, {
        ...
        children: [
          (0, M.jsx)(`span`, { className: `text-muted-foreground`, children: `音量` }),
          (0, M.jsxs)(`span`, {
      ...
      (0, M.jsxs)(`div`, {
        ...
        children: [
          (0, M.jsx)(`span`, { children: `0%` }),
          (0, M.jsx)(`span`, { children: `500%` }),
          (0, M.jsx)(`span`, { children: `1000%` }),
        ],
      }),
    ],
  });
}
function cr({ value: e, disabled: t, onChange: n }) {
  return (0, M.jsxs)(`div`, {
    className: `flex flex-col gap-2`,
    children: [
      (0, M.jsxs)(`div`, {
        className: `flex items-center justify-between text-sm`,
        children: [
          (0, M.jsx)(`span`, { className: `text-muted-foreground`, children: `ピッチ` }),
          (0, M.jsxs)(`span`, {
            className: `font-mono tabular-nums text-foreground`,
            children: [e > 0 ? `+` : ``, e],
          }),
...
function lr({ audio: e }) {
  let t = (0, _.useSyncExternalStore)(
      e.subscribeState,
      () => e.state,
      () => `idle`,
    ),
    n = (0, _.useSyncExternalStore)(
      e.subscribeState,
      () => e.pitchSemiTones,
      () => 0,
    ),
    r = (0, _.useSyncExternalStore)(
      e.subscribeState,
      () => e.volume,
      () => e.volume,
    ),
    i = (0, _.useSyncExternalStore)(
      e.subscribeState,
      () => e.recordingDuration,
      () => 0,
    ),
    a = (0, _.useSyncExternalStore)(
      e.subscribeState,
      () => e.audioBuffer,
      () => null,
    ),
  ...
  return (0, M.jsx)(`div`, {
    ...
    children: (0, M.jsxs)(`div`, {
      className: `w-full max-w-md bg-background border border-border rounded-xl p-6 flex flex-col gap-6 shadow-sm`,
      children: [
        (0, M.jsx)(`h1`, {
          className: `text-center text-lg font-semibold text-foreground`,
          children: `Record & Pitch`,
        }),
        (0, M.jsxs)(`div`, {
          className: `flex flex-col items-center gap-2`,
          children: [
            (0, M.jsx)(ve, { isRecording: o, isDisabled: s, onToggle: () => e.toggleRecording() }),
            (0, M.jsx)(`span`, {
        ...
        (0, M.jsx)(Ce, {
          audio: e,
          leftControl: (0, M.jsx)(ye, {
            isPlaying: s,
            isDisabled: !c || o,
            onClick: () => (s ? e.stop() : e.togglePlayPause()),
          }),
        }),
        (0, M.jsx)(sr, { value: r, disabled: !c || o, onChange: (t) => e.setVolume(t) }),
        (0, M.jsx)(cr, { value: n, disabled: !c || o, onChange: (t) => e.setPitch(t) }),
      ],
    }),
  });
}
var ur = ge(),
  dr = document.getElementById(`app`);
(0, v.createRoot)(dr).render((0, M.jsx)(_.StrictMode, { children: (0, M.jsx)(lr, { audio: ur }) }));
